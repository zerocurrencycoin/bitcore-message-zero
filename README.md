...
bitcore-message-zero adds support for verifying and signing zero messages in [Node.js](http://nodejs.org/) and web browsers.
...
var Message = require('bitcore-message-zero');
